        ...
        var marqueeActivator = (function() {
            ...
            return {
                ...
                selectMove: function(e) {
                    if (designer.getStatus() === 'textedit') {
                        return;
                    }
                    ...
                    if (!marqueeMode) {
                        ...
                        designer.removeAllSelectedNodes();

                        marqueeMode = true;
                        rc.addShape(marqueeShape);
                        marqueeShape
                            .fill(designer.getStyle('marquee-background'))
                            .stroke(designer.getStyle('marquee-stroke')).setOpacity(0.8).getDrawer().clear();
                    }
                    ...
                    // 应用选中范围
                    designer.select(selectedNodes, true);
        ...
        return {
            ...
            'events': {
                'mousedown': function(e) {
                    //hand模式或者右键拖拽时，不触发select
                    if (designer.getStatus() === 'hand' || e.originEvent.button === 2) {
                        return;
                    }
                    ...
                    if (!downNode) {
                        ...
                        if(!(targetShape && targetShape.getId && ~targetShape.getId().indexOf('line'))){
