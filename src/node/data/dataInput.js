 ...
 */
 define(function(require, exports, module){
    ...
    var DataInputShape = kity.createClass('DataInputShape',{
        base: OutlineManager,
        create: function(node, width, height){
            ...
            //标志
            var sign = new kity.Path().stroke(
                node.getStyle('normal-stroke'),1
            );
            group.addShape(rect);
            group.addShape(sign);
            ...
            rect.setId(utils.uuid('dataInput'));
            this._node = node;
    ...
    Designer.registerOutline('dataInput',DataInputShape);
 });
